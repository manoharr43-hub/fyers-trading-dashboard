"""
option_chain.py - UPGRADED VERSION (FIXED)
====================================
...
✅ FIXED IMPORTS & MODULE STRUCTURE
"""
...
MCX_COMMODITY_URL = f"{NSE_BASE_URL}/api/option-chain-indices"  # Uses NSE API
