"""
option_chain.py (ENHANCED VERSION WITH COMMODITIES)
===================================================
...
price action analysis, and commodities support.
"""
...
def _sidebar_config() -> dict:
    """Enhanced sidebar with commodities support."""
    with st.sidebar:
        ...
        # Lot size with commodity support (NEW)
        if is_commodity:
    ...
    return {
        ...
        "refresh_secs": refresh_secs, "debug_mode": debug_mode, "fetch_clicked": fetch_clicked,
...
def _do_fetch_and_process(cfg: dict, fyers: Any = None) -> Optional[dict]:
    ...
    # NEW: Routing for commodities vs equities/indices
    ...
    # NEW: Separate IV tracking for commodities
